...
Register-WafCheck -Pillar 'Reliability' -Id 'RE02' -Name 'Identify & rate flows' -Description 'Application Insights map and criticality tags' -InvokeScript {
  ...
  New-WafResult -Pillar 'Reliability' -Id 'RE02' -Name 'Identify & rate flows' -Description 'App Insights present + criticality tags' `
