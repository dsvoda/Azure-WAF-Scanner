...
Register-WafCheck -Pillar 'Reliability' -Id 'RE:09' -Name 'BCDR plans implemented' -Description 'ASR/Backup coverage & tested plans' -InvokeScript {
  ...
  New-WafResult -Pillar 'Reliability' -Id 'RE:09' -Name 'BCDR plans implemented' -Description 'ASR protected items present' `
