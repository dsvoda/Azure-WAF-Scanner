...
Register-WafCheck -Pillar 'Reliability' -Id 'RE01' -Name 'Simplicity & efficiency' -Description 'Advisor simplification & resource graph complexity' -InvokeScript {
...
"@
  ...
  New-WafResult -Pillar 'Reliability' -Id 'RE01' -Name 'Simplicity & efficiency' -Description 'Advisor + complexity snapshot' `
