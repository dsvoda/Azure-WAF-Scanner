...
Register-WafCheck -Pillar 'Reliability' -Id 'RE:07' -Name 'Self-healing measures' -Description 'LB health probes & VMSS automatic repairs' -InvokeScript {
  ...
  New-WafResult -Pillar 'Reliability' -Id 'RE:07' -Name 'Self-healing measures' -Description 'LB probes and VMSS automatic repairs' `
