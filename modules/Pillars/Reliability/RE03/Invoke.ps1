...
Register-WafCheck -Pillar 'Reliability' -Id 'RE03' -Name 'Failure mode analysis' -Description 'Dependencies & single points via ARG; Advisor HA' -InvokeScript {
...
"@
  ...
  New-WafResult -Pillar 'Reliability' -Id 'RE03' -Name 'Failure mode analysis' -Description 'Singleton VMs & HA Advisor recs' `
