...
Register-WafCheck -Pillar 'Reliability' -Id 'RE10' -Name 'Measure & model health' -Description 'Uptime/health metrics via Monitor/App Insights' -InvokeScript {
  ...
  New-WafResult -Pillar 'Reliability' -Id 'RE10' -Name 'Measure & model health' -Description 'Alerts + App Insights presence' `
