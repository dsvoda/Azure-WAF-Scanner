...
Register-WafCheck -Pillar 'Performance Efficiency' -Id 'PE:11' -Name 'Respond to live performance issues' -Description 'Service Health alerts + action groups' -InvokeScript {
  ...
  New-WafResult -Pillar 'Performance Efficiency' -Id 'PE:11' -Name 'Respond to live performance issues' -Description 'Service Health alerts wired to action groups' `
