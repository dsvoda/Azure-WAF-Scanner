...
Register-WafCheck -Pillar 'Performance Efficiency' -Id 'PE:01' -Name 'Define performance targets' -Description 'Alert rules for perf SLOs' -InvokeScript {
  ...
  New-WafResult -Pillar 'Performance Efficiency' -Id 'PE:01' -Name 'Define performance targets' -Description 'Metric alerts as target proxies' `
