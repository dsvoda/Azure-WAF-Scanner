...
Register-WafCheck -Pillar 'Performance Efficiency' -Id 'PE:04' -Name 'Collect performance data' -Description 'Diagnostics + App Insights presence' -InvokeScript {
  ...
  New-WafResult -Pillar 'Performance Efficiency' -Id 'PE:04' -Name 'Collect performance data' -Description 'Diagnostics + App Insights' `
