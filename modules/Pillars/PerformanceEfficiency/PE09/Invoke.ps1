...
Register-WafCheck -Pillar 'Performance Efficiency' -Id 'PE:09' -Name 'Prioritize critical flows' -Description 'Criticality tags present (approx)' -InvokeScript {
  ...
  New-WafResult -Pillar 'Performance Efficiency' -Id 'PE:09' -Name 'Prioritize critical flows' -Description 'Criticality tags' `
