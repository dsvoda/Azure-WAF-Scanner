...
Register-WafCheck -Pillar 'Security' -Id 'SE08' -Name 'Harden components' -Description 'Defender secure score & open recommendations' -InvokeScript {
  ...
  New-WafResult -Pillar 'Security' -Id 'SE08' -Name 'Harden components' -Description 'Open security assessments' `
