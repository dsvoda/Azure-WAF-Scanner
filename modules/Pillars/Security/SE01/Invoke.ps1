...
Register-WafCheck -Pillar 'Security' -Id 'SE01' -Name 'Security baseline & posture' -Description 'Policy/Defender baseline coverage' -InvokeScript {
  ...
  New-WafResult -Pillar 'Security' -Id 'SE01' -Name 'Security baseline & posture' -Description 'Policy summary + Secure Score' `
