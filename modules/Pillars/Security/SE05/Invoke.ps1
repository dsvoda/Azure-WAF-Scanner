...
Register-WafCheck -Pillar 'Security' -Id 'SE:05' -Name 'Strict IAM' -Description 'Owner assignments (user principals) and privileged roles' -InvokeScript {
  ...
  New-WafResult -Pillar 'Security' -Id 'SE:05' -Name 'Strict IAM' -Description 'User Owners at subscription scope' `
