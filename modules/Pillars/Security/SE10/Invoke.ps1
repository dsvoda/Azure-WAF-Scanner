...
Register-WafCheck -Pillar 'Security' -Id 'SE:10' -Name 'Threat detection & alerting' -Description 'Defender plans + Monitor alerts' -InvokeScript {
  ...
  New-WafResult -Pillar 'Security' -Id 'SE:10' -Name 'Threat detection & alerting' -Description 'Defender pricing + Activity alerts' `
