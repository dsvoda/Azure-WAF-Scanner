...
Register-WafCheck -Pillar 'Security' -Id 'SE:12' -Name 'Incident response' -Description 'Sentinel/Playbooks presence (approx)' -InvokeScript {
  ...
  New-WafResult -Pillar 'Security' -Id 'SE:12' -Name 'Incident response' -Description 'LA workspaces + Logic Apps' `
