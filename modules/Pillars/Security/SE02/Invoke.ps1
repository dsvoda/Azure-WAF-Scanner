...
Register-WafCheck -Pillar 'Security' -Id 'SE:02' -Name 'Secure SDLC & supply chain' -Description 'DevOps security signals (approx)' -InvokeScript {
  param([string]$SubscriptionId)

  $status = 'Manual'
  New-WafResult -Pillar 'Security' -Id 'SE:02' -Name 'Secure SDLC & supply chain' -Description 'Validate pipelines scanning (Defender for DevOps)' `
