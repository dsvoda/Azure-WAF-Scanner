...
Register-WafCheck -Pillar 'Security' -Id 'SE:06' -Name 'Ingress/egress controls' -Description 'NSGs + Firewall + DDoS plan' -InvokeScript {
  ...
  New-WafResult -Pillar 'Security' -Id 'SE:06' -Name 'Ingress/egress controls' -Description 'Subnets with NSGs; central firewall; DDoS' `
