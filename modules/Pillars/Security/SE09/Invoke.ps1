...
Register-WafCheck -Pillar 'Security' -Id 'SE:09' -Name 'Protect secrets (Key Vault)' -Description 'KV soft delete & purge protection, RBAC' -InvokeScript {
  ...
  New-WafResult -Pillar 'Security' -Id 'SE:09' -Name 'Protect secrets (Key Vault)' -Description 'Soft delete & purge protection' `
