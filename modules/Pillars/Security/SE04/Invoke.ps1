...
Register-WafCheck -Pillar 'Security' -Id 'SE04' -Name 'Segmentation & perimeters' -Description 'NSG on all subnets; firewall for egress' -InvokeScript {
...
"@
  ...
  New-WafResult -Pillar 'Security' -Id 'SE04' -Name 'Segmentation & perimeters' `
