...
Register-WafCheck -Pillar 'Security' -Id 'SE:11' -Name 'Security testing regimen' -Description 'Vulnerability assessment signals' -InvokeScript {
  ...
  New-WafResult -Pillar 'Security' -Id 'SE:11' -Name 'Security testing regimen' -Description 'Vulnerability assessments present' `
