...
Register-WafCheck -Pillar 'Cost Optimization' -Id 'CO09' -Name 'Optimize flow costs' -Description 'Tags for flows/priorities (approx)' -InvokeScript {
  ...
  New-WafResult -Pillar 'Cost Optimization' -Id 'CO09' -Name 'Optimize flow costs' -Description 'Flow/criticality tags present' `
