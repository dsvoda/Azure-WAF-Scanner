...
Register-WafCheck -Pillar 'Cost Optimization' -Id 'CO:14' -Name 'Consolidate resources & responsibility' -Description 'Identify single-resource RGs (approx)' -InvokeScript {
  ...
  New-WafResult -Pillar 'Cost Optimization' -Id 'CO:14' -Name 'Consolidate resources & responsibility' -Description 'RGs with a single resource' `
