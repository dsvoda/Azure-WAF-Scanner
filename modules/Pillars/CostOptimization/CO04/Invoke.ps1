...
Register-WafCheck -Pillar 'Cost Optimization' -Id 'CO04' -Name 'Spending guardrails' -Description 'Policy guardrails presence' -InvokeScript {
  ...
  New-WafResult -Pillar 'Cost Optimization' -Id 'CO04' -Name 'Spending guardrails' -Description 'Allowed locations/SKU/type policies present' `
