...
Register-WafCheck -Pillar 'Cost Optimization' -Id 'CO02' -Name 'Cost model maintained' -Description 'Forecasts (approx)' -InvokeScript {
  ...
  New-WafResult -Pillar 'Cost Optimization' -Id 'CO02' -Name 'Cost model maintained' -Description 'Costs available for forecasting' `
