...
Register-WafCheck -Pillar 'Cost Optimization' -Id 'CO05' -Name 'Use best rates' -Description 'Advisor: reservations/savings opportunities' -InvokeScript {
  ...
  New-WafResult -Pillar 'Cost Optimization' -Id 'CO05' -Name 'Use best rates' -Description 'Advisor cost savings' `
