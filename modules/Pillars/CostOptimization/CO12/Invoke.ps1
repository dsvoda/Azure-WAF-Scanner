...
Register-WafCheck -Pillar 'Cost Optimization' -Id 'CO12' -Name 'Optimize scaling costs' -Description 'Autoscale & rightsizing' -InvokeScript {
  ...
  New-WafResult -Pillar 'Cost Optimization' -Id 'CO12' -Name 'Optimize scaling costs' -Description 'Autoscale presence + Advisor rightsizing' `
