...
Register-WafCheck -Pillar 'Cost Optimization' -Id 'CO03' -Name 'Collect & review cost data' -Description 'Daily cost capture, trends, budgets, alerts' -InvokeScript {
  ...
  New-WafResult -Pillar 'Cost Optimization' -Id 'CO03' -Name 'Collect & review cost data' `
