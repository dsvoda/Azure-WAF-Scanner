...
Register-WafCheck -Pillar 'Cost Optimization' -Id 'CO:10' -Name 'Optimize data costs' -Description 'Storage tiering & lifecycle policies' -InvokeScript {
  ...
  New-WafResult -Pillar 'Cost Optimization' -Id 'CO:10' -Name 'Optimize data costs' -Description 'Storage lifecycle policies present' `
