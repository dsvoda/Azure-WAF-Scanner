...
Register-WafCheck -Pillar 'Cost Optimization' -Id 'CO08' -Name 'Optimize environment costs' -Description 'Environment tags + budgets per env (approx)' -InvokeScript {
  ...
  New-WafResult -Pillar 'Cost Optimization' -Id 'CO08' -Name 'Optimize environment costs' -Description 'Environment tagging present' `
