...
Register-WafCheck -Pillar 'Operational Excellence' -Id 'OE:07' -Name 'Monitoring & telemetry' -Description 'Diag settings + App Insights presence' -InvokeScript {
  ...
  New-WafResult -Pillar 'Operational Excellence' -Id 'OE:07' -Name 'Monitoring & telemetry' -Description 'Diag settings + App Insights' `
