...
Register-WafCheck -Pillar 'Operational Excellence' -Id 'OE05' -Name 'Infrastructure as Code' -Description 'ARM/Bicep deployments presence (approx)' -InvokeScript {
  ...
  New-WafResult -Pillar 'Operational Excellence' -Id 'OE05' -Name 'Infrastructure as Code' -Description 'ARM/Bicep deployments detected' `
