...
Register-WafCheck -Pillar 'Operational Excellence' -Id 'OE09' -Name 'Automate repetitive tasks' -Description 'Automation jobs/schedules' -InvokeScript {
  ...
  New-WafResult -Pillar 'Operational Excellence' -Id 'OE09' -Name 'Automate repetitive tasks' -Description 'Scheduled runbooks present' `
