...
Register-WafCheck -Pillar 'Operational Excellence' -Id 'OE11' -Name 'Safe deployment practices' -Description 'App Service deployment slots presence' -InvokeScript {
  ...
  New-WafResult -Pillar 'Operational Excellence' -Id 'OE11' -Name 'Safe deployment practices' -Description 'Deployment slots (blue/green/canary)' `
