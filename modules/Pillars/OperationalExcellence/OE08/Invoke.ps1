...
Register-WafCheck -Pillar 'Operational Excellence' -Id 'OE:08' -Name 'Emergency operations practice' -Description 'Manual; Sentinel recommended' -InvokeScript {
  ...
  New-WafResult -Pillar 'Operational Excellence' -Id 'OE:08' -Name 'Emergency operations practice' -Description 'IR plan & drills; Sentinel suggested' `
