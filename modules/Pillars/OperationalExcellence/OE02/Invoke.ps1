...
Register-WafCheck -Pillar 'Operational Excellence' -Id 'OE:02' -Name 'Formalized ops tasks' -Description 'Standardize routine/emergency tasks as runbooks' -InvokeScript {
  ...
  New-WafResult -Pillar 'Operational Excellence' -Id 'OE:02' -Name 'Formalized ops tasks' `
